...
### Problem statement
Landsuddelingen would like to predict which Hjertestarter groups they should target with additional support in order to increase the odds they reach a minimum of 15 collectors (indsamler).
...
The hypothesis was that groups that signed up more collectors over a short time span were more likely to succeed in reaching 15 collectors, and conversly, those groups that were slow to sign up collectors were at risk for being near-misses. For example, a group that signed up the first 5 collectors in 2 weeks might be more likely to succeed than a group that takes 4 weeks to reach the same number. Other potential predictor variables could include the presence/absence of a group coordinator and date of the groups creation.



could include gender, age, previous LU experience, have or know someone with a CVD

In order to build a prediction model for near-misses, the LU delivered the datasets for LU 2019 to anlayseenheden
